...
class CoNLLDataManager(BaseDataManager):
    ...
    def setup(self):
        ds = CoNLLDataset4Bert if self.bert else CoNLLDataset
        self.train_dataset = ds(self.padding_size, self.train_file)
        vocabs = self.train_dataset.get_vocabs()
        self.val_dataset = ds(self.padding_size, self.val_file, vocabs)
        self.test_dataset = ds(self.padding_size, self.test_file, vocabs)
